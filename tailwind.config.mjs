	...
	theme: {
		extend: {
			colors: {
				...
				'blue_(crayola)': { DEFAULT: '#2879fe', 100: '#00173b', 200: '#012d76', 300: '#0144b1', 400: '#015beb', 500: '#2879fe', 600: '#5496fe', 700: '#7fb0fe', 800: '#aacaff', 900: '#d4e5ff' },
				...
				'bright_pink_(crayola)': { DEFAULT: '#ff5964', 100: '#440005', 200: '#890009', 300: '#cd000e', 400: '#ff1222', 500: '#ff5964', 600: '#ff7881', 700: '#ff9aa1', 800: '#ffbcc0', 900: '#ffdde0' },
